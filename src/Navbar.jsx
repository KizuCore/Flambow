...
function Navbar() {
  // Copie l'email en presse-papiers, avec fallback "mailto" si nécessaire.
  ...
  // Style partagé pour les icônes sociales.
  const iconLinkClass =
    "group flex h-[38px] w-[38px] items-center justify-center rounded-full border-2 border-[#787fdc] bg-white transition-all duration-300 hover:bg-[#787fdc]";

  return (
    <header className="fixed left-16 right-16 top-6 z-[100] mx-auto flex h-[100px] max-w-[1600px] items-start justify-between overflow-hidden rounded-[50px] bg-white/10 px-16 py-[30px] backdrop-blur-[10px] max-[900px]:left-0 max-[900px]:right-0 max-[900px]:top-0 max-[900px]:h-auto max-[900px]:w-full max-[900px]:flex-col max-[900px]:items-center max-[900px]:justify-center max-[900px]:gap-3 max-[900px]:rounded-none max-[900px]:px-3 max-[900px]:py-3">
      {/* Réseaux sociaux + action email. */}
      <div className="flex items-start gap-[10px]">
        ...
        >
          <svg
            ...
            viewBox="0 0 20 20"
            fill="none"
            className="h-6 w-6 text-[#787fdc] transition-colors duration-300 group-hover:text-white"
          >
            <path
      ...
      {/* CTA principal vers le prototype Figma. */}
      <Button
